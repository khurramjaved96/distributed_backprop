...
void Neuron::SetIsInput(bool is_input) {
  Neuron::is_input = is_input;
}
...
void Neuron::SetIsOutput(bool is_output) {
...
float LinearNeuron::Forward() {
  return this->value;
}

float LinearNeuron::Backward() {
  return 1;
}
